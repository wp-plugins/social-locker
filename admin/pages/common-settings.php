...
<div id="facebook" class="panel like-panel">
 ...
 <fieldset style="padding-top: 10px;">
    ...
    <?php ?>
    <div class="control-group">
        <label class="control-label" for="sociallocker_tracking">Tracking</label>
        <?php 
        $checked = get_option('sociallocker_tracking') ? 'checked="checked"' : '';
        ?>
        <div class="controls">
            ...
            <input style="display: none;" type='checkbox' value='1' <?php echo $checked ?> name='sociallocker_tracking' id='sociallocker_tracking' /> 
            
            <span class="help-block">
                Allows to track of unlocking events on your site and provides statistics.
            </span>
        </div>
    </div>
    <?php 
