...
<html>
    <head>
         ...
         <?php ?>
         <script type="text/javascript" src="<?php echo ONP_SL_PLUGIN_URL ?>/assets/js/jquery.op.sociallocker.030405.min.js"></script>  
         <link rel="stylesheet" type="text/css" href="<?php echo ONP_SL_PLUGIN_URL ?>/assets/css/jquery.op.sociallocker.030405.min.css">  
         <?php 
 ?>
