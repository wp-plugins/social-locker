...
?>
    ...
    <div class="wrap">
        ...
        <div id="chart-selector">
            ...
            <?php ?>
            <div class="chart-item facebook-share">
                <span class="chart-color"></span>
                Facebook Shares
            </div>
            <?php 
 ?>
            ...
            <?php ?>
            <div class="chart-item twitter-follow">
                <span class="chart-color"></span>
                Twitter Followers
            </div>
            <?php 
 ?>
            ...
            <?php ?>
            <div class="chart-item google-share">
                <span class="chart-color"></span>
                Google Shares
            </div>
            <div class="chart-item linkedin-share">
                <span class="chart-color"></span>
                LinkedIn Shares
            </div>
            <?php 
 ?>
        ...
        <table id="posts-table">
            <thead>
                ...
                <?php ?>
                <th class="col-number col-facebook-share">Facebook Shares</th> 
                <?php 
 ?>
                <th class="col-number col-twitter-tweet">Twitter Tweets</th>  
                <?php ?>
                <th class="col-number col-twitter-follow">Twitter Follower</th>
                <?php 
 ?>
                <th class="col-number col-google-plus">Google Plusoners</th> 
                <?php ?>
                <th class="col-number col-google-share">Google Shares</th>   
                <th class="col-number col-linkedin-share">LinkedIn Shares</th>  
                <?php 
 ?>
