...
// Loads plugin's code created via Factory.

require('factory/core/start.php');
$socialLocker = factory_fr100_create_plugin(
   __FILE__, 'sociallocker-next', '2.0.2', 'free',
