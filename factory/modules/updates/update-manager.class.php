...
class FactoryPR108UpdatePR108Manager {
    ...
    public function __construct( $plugin ) {
        ...
        if ( is_admin() ) {
            ...
            if ( $this->needChangeAssembly() ) {
                ...
                add_filter('factory_pr108_plugin_row-' . $this->plugin->pluginName, array($this, 'showChangeAssemblyPluginRow' ), 10, 3); 
                add_filter('factory_pr108_admin_notices-' . $this->plugin->pluginName, array( $this, 'showAssemblyMessages'), 10, 2);    
            }
            ...
            add_action('factory_pr108_activation_or_update-' . $plugin->pluginName, array($this, 'activationOrUpdateHook'));
            add_action('factory_pr108_deactivation-' . $plugin->pluginName, array($this, 'deactivationHook')); 
        }
    }
    ...
    public function clearUpdates() {
        ...
        if ( !empty( $transient) ) {
            ...
            factory_pr108_set_site_transient('update_plugins', $transient);  
        }
    }
