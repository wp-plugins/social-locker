 ...
 */
class OnePressPR108LicenseManagerAdminPage extends FactoryPR108AdminPage  {
    ...
    public function assets(FactoryPR108ScriptList $scripts, FactoryPR108StyleList $styles) {
        ...
        $styles->add(ONEPRESS_PR108_URL . '/assets/css/license-manager.css');
        $scripts->add(ONEPRESS_PR108_URL . '/assets/js/license-manager.js');   
    }
                ...
                <?php } else { ?>
                        ...
                        <?php if ($sender == 'trial') { ?>
                            ...
                            <div class="alert alert-normal alert-warning-icon">
                                ...
                                <p><?php _e('Thank you for using OnePress plugin. Feel free to contact us to get support.', 'onepress') ?></p>  
                                <p>
                                    <?php printf(
                                            __('Please <a href="%1$s">click here</a> to refresh the page and apply changes.', 'onepress'),
                                            onepress_pr108_get_link_license_manager($this->plugin->pluginName, 'index') ) ?>
                                </p>  
                            </div>
                            <?php 
 ?>
...
if ( !in_array( $socialLocker->license->type, array( 'paid' ) ) ) {
 ?>
                        <a href="<?php echo $this->plugin->options['premium'] ?>" id="purchase-premium">
                            ...
                            <i class="icon-star icon-white"></i> <?php printf( __('Get Key For %1$s Only', 'onepress'), $this->purchasePrice ) ?> <i class="icon-star icon-white"></i>
                            <?php } else { ?>
                            <i class="icon-star icon-white"></i> <?php _e('Get Premium Key', 'onepress') ?> <i class="icon-star icon-white"></i>
                            <?php } ?>
                            </span>
                        </a> 
                        <?php 
                    ...
                    <li>
                        ...
                        <div>
                            ...
                            <p style="text-align: center;">
                                <img src="<?php echo ONEPRESS_PR108_URL . '/assets/img/how-to-find-key.png' ?>" />
                            </p>
                        </div>
                    </li>
                    <li>
