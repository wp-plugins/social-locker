...
abstract class FactoryFormPR108Metabox extends FactoryPR108Metabox {
    ...
    public function __construct( $plugin = null, $valueProvider = null ) {
        ...
        $this->valueProvider = $valueProvider ? $valueProvider : new FactoryPR108MetaValueProvider();
    ...
    private function getForm( $post_id = null ) {
        ...
        $form = new FactoryFormPR108( $this->plugin, $this->valueProvider );
        $this->form( $form );
     ...
     */
    public abstract function form(FactoryFormPR108 $form);
    
    /**
     * Method executed before rendering the form.
     */
    public function beforeForm(FactoryFormPR108 $form) {
        return;
    }
     ...
     */
    public function afterForm(FactoryFormPR108 $form) {
        return;
    }
