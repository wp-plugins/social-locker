...
class FactoryFormPR108 {
    ...
    public function __construct( FactoryPR108Plugin $plugin, $valueProvider = null ) {
        
        $this->plugin = $plugin;
        $this->valueProvider = $valueProvider ? $valueProvider : new FactoryPR108FakeValueProvider();     
    }
    ...
    private function build() {
        ...
        $this->items = apply_filters('factory_pr108_form', $this->items, $this->scope, $this->name);    
        $this->items = apply_filters('factory_form_pr108_' . $this->name, $this->items, $this->scope);
    ...
    public function render() {
        ...
        $root = new FactoryFormPR108Item(array(), null);
        $currentLevel = $root;
            ...
            if (is_array($item)){
                ...
                switch( $item['type'] ) {
                   ...
                   case 'tab':
                       ...
                       $tab = new FactoryFormPR108Tab( $item, $levelToUse );
                   ...
                   case 'tab-item':
                       ...
                       $tabItem = new FactoryFormPR108TabItem( $item, $currentTab );
                   ...
                   case 'group':
                       ...
                       $group = new FactoryFormPR108Group( $item, $currentLevel );
                       $currentLevel = $group;
                   ...
                   case 'collapsed':
                       ...
                       $collapsed = new FactoryFormPR108Collapsed( $item, $currentLevel );
