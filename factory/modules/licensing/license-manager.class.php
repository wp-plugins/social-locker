...
class FactoryLicenseManager {
    ...
    public function clearVersionCheck() {
        ...
        if ( !empty( $transient) ) {
            ...
            factory_fr103_set_site_transient('update_plugins', $transient);  
        }
    }
	...
	if ( is_network_admin() || !is_multisite() ) {
            ...
            if ( $this->needKey() ) {
                ...
                $message = apply_filters('factory_fr103_activation_message_' . $this->plugin->pluginName, $message);
