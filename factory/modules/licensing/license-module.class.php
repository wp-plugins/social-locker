 ...
 */
class FactoryLicensingPR108Module {
    ...
    public function __construct( $plugin ) {
        ...
        // licensing
        $this->plugin = $plugin;
        $this->license = new FactoryLicensingPR108Manager( $plugin );
...
add_action('factory_pr108_load_licensing', 'factory_licensing_pr108_module_load');
function factory_licensing_pr108_module_load( $plugin ) {
    new FactoryLicensingPR108Module( $plugin ); 
}