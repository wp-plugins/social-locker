...
abstract class FactoryPR108ViewTable {
    ...
    public function register( FactoryPR108Type $type ) {
        
        $this->type = $type;
        $this->plugin = $type->plugin;
        $this->columns = new FactoryPR108ViewTableColumns();
        
        $this->adminScripts = new FactoryPR108ScriptList( $type->plugin );
        $this->adminStyles = new FactoryPR108StyleList( $type->plugin ); 
    ...
    public abstract function configure( 
            FactoryPR108ViewTable $table, 
            FactoryPR108ScriptList $scripts, 
            FactoryPR108StyleList $styles );
