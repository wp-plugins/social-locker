 ...
 */
class FactoryPR108ShortcodeManager {
        ...
        if ($isAdmin) { 
            ...
            foreach( $this->blanks as $blank ) {
                ...
                if ($blank->tracking) {
                    ...
                    foreach($blank->shortcode as $shortcode) {
                        factory_pr108_tr_register_shortcode(
    ...
    public function actionSavePost( $postid ) {
        ...
        factory_pr108_tr_check_content($post->post_content, $postid);
    }
    ...
    private function checkAssets( $blank, $post, $postid ) {
        ...
        foreach($blank->shortcode as $shortcode) {
            $metaName = 'factory_pr108_' . $shortcode . '_include_assets';
