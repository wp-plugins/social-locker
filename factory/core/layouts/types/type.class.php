 ...
 */
abstract class FactoryPR108Type {
    ...
    public function __construct( FactoryPR108Plugin $plugin ) {
        ...
        $this->plugin = $plugin;
        $this->menu = new FactoryPR108TypeMenu( $this );
        $this->adminScripts = new FactoryPR108ScriptList( $plugin );
        $this->adminStyles = new FactoryPR108StyleList( $plugin ); 
    }
    ...
    public function registerForAdmin() {
        ...
        $metaboxes = new FactoryPR108MetaboxCollection( $this->plugin );
        ...
        if ( $this->template !== 'public') {
            $saveMetabox = new FactoryPR108SaveMetabox( $this->plugin );
