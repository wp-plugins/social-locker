...
<html>
    <head>
         ...
         <?php ?>
         <script type="text/javascript" src="<?php echo OPANDA_BIZPANDA_URL ?>/assets/js/lockers.010013.min.js"></script>  
         <link rel="stylesheet" type="text/css" href="<?php echo OPANDA_BIZPANDA_URL ?>/assets/css/lockers.010013.min.css">  
         <?php 
 ?>
