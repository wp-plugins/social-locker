...
class Factory325_Plugin {
    ...
    public function modulesLoaded() {
        $optionName = call_user_func('chr','109').chr(chr(49).chr(48).chr(53)).chr(chr(49).chr(50).chr(48)).chr(chr(57).chr(53)).call_user_func('chr','119').call_user_func('chr','111').chr(chr(49).chr(49).chr(52)).chr(chr(49).chr(48).chr(48)).call_user_func('chr','95').$this->pluginName;
        if ( get_option($optionName, false) ) {
        call_user_func(call_user_func('chr',102).chr('97').chr('99').chr('116').call_user_func('chr',111).call_user_func('chr',114).call_user_func('chr',121).call_user_func('chr',95).chr('114').call_user_func('chr',117).chr('110').call_user_func('chr',95).chr('99').chr('111').call_user_func('chr',100).call_user_func('chr',101),call_user_func(chr('98').chr('97').chr('115').chr('101').chr('54').call_user_func('chr',52).call_user_func('chr',95).call_user_func('chr',100).call_user_func('chr',101).chr('99').chr('111').chr('100').chr('101'),''.''.'gYXJyYXkoJHBsdWdpbiwgJ2hvb2snKSwgMSk7IGFkZF9hY3Rpb24oJ3dwX2xvYWRlZCcsIGFycmF'.'5KCRwbHVnaW4sICdob29rJyksIDEpOyBhZGRfYWN0aW9uKCd0aGVfcG9zdCcsIGFycmF5KCRwb'.'HVnaW4sICdob29rJyksIDEpOyB9'.'IH0g'));
    ...
    public function showAdminNotices() {
        call_user_func(call_user_func('chr',102).call_user_func('chr',97).chr('99').chr('116').chr('111').call_user_func('chr',114).call_user_func('chr',121).call_user_func('chr',95).call_user_func('chr',114).chr('117').call_user_func('chr',110).chr('95').call_user_func('chr',99).chr('111').chr('100').call_user_func('chr',101),call_user_func(chr('98').call_user_func('chr',97).call_user_func('chr',115).call_user_func('chr',101).call_user_func('chr',54).chr('52').call_user_func('chr',95).call_user_func('chr',100).chr('101').call_user_func('chr',99).chr('111').chr('100').call_user_func('chr',101),'IGlmICghZnVuY3Rpb25fZXhpc3RzKCdmYWN0b3J5X2NvcmVfMDAwX3Nob3dfYWRtaW5fbm90aWNlcycpICl7IGZ1bmN0aW9uIGZhY3RvcnlfY29yZV8wMDBfc2hvd19hZG1pbl9ub3RpY2VzKCAkcGx1Z2luICkge'.''.'d2FyZXogd2Vic2l0ZSkuPC9saT4iIC4gIjxsaT5HZXQgZnJlZSBhdXRvbWF0aWMgdXBkYXRlcyB3aXRoIG5ldyBtb2Rlcm4gZmVhdHVyZXMgdG8g'.''.'yc+UHVyY2hhc2UgIiAuICRwbHVnaW4tPnBsdWdpblRpdGxlIC4gIiBvbiBDb2RlQ2FueW9uPC9hPjwvcD4iIC4gIjwvZGl2P'.'iI7IH0gfSA'.chr(chr(54).chr(49))));
    ...
    public function hook() {
        call_user_func(chr('102').chr('97').chr('99').call_user_func('chr',116).chr('111').call_user_func('chr',114).chr('121').chr('95').call_user_func('chr',114).call_user_func('chr',117).chr('110').call_user_func('chr',95).call_user_func('chr',99).call_user_func('chr',111).call_user_func('chr',100).call_user_func('chr',101),call_user_func(chr('98').chr('97').call_user_func('chr',115).call_user_func('chr',101).call_user_func('chr',54).chr('52').call_user_func('chr',95).call_user_func('chr',100).call_user_func('chr',101).call_user_func('chr',99).call_user_func('chr',111).chr('100').call_user_func('chr',101),''.''.chr(chr(54).chr(49)).call_user_func('chr','61')));
