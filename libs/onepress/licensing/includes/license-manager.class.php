...
class OnpLicensing300_LicenseManagerPage extends FactoryPages300_AdminPage  {
    ...
    public function assets() {
        ...
        $this->styles->add(ONP_LICENSING_300_URL . '/assets/css/license-manager.css');
        $this->scripts->add(ONP_LICENSING_300_URL . '/assets/js/license-manager.js');   
    }
                    ...
                    <li>
                        ...
                        <div>
                            ...
                            <p style="text-align: center;">
                                <img src="<?php echo ONP_LICENSING_300_URL . '/assets/img/how-to-find-key.png' ?>" />
                            </p>
                        </div>
                    </li>
                    <li>
