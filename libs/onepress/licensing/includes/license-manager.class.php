                ...
                <div class="license-details">
                    <?php ?>
                        ...
                        <a href="<?php onp_licensing_324_purchase_url( $this->plugin ) ?>" id="purchase-premium">
                            ...
                            <i class="fa fa-star"></i> <?php printf( __('Upgrade to Premium for %1$s', 'onp_licensing_324'), $this->purchasePrice ) ?> <i class="fa fa-star"></i></i>
                            <?php } else { ?>
                            <i class="fa fa-star"></i> <?php _e('Upgrade to Premium', 'onp_licensing_324') ?> <i class="fa fa-star"></i></i>
                            <?php } ?>
                            </span>
                        </a>
                        <?php } ?>
