( function( $ ){
    ...
    $.fn.factoryBootstrap313_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap313_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-313 .factory-paddings-editor").factoryBootstrap313_paddingsEditor();
    });
