( function( $ ){
    ...
    $.fn.factoryBootstrap320_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap320_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-320 .factory-paddings-editor").factoryBootstrap320_paddingsEditor();
    });
