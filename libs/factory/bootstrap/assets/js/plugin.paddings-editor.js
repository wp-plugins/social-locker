( function( $ ){
    ...
    $.fn.factoryBootstrap322_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap322_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-322 .factory-paddings-editor").factoryBootstrap322_paddingsEditor();
    });
