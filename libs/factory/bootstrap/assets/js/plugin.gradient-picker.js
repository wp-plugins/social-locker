	...
	GradientSelection.prototype = {    
		...
		this.g2d = canvas.getContext("2d");
            ...
            _createColorPicker: function() {
                ...
                this.$colorPicker.factoryBootstrap308_iris({
                    width: 217,
                ...
                self.$colorHex.on('change paste keyup', function(){
                    ...
                    self.$colorPicker.factoryBootstrap308_iris('color', self.$colorHex.val());
		...
		this.$el.append( this.$directionDropdown );  
            ...
            showColorPicker: function( point ) {
                ...
                this.$colorPicker.factoryBootstrap308_iris( 'show' );
                this.$colorPicker.factoryBootstrap308_iris( 'option', 'color', point.color );
