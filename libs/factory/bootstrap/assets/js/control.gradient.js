( function( $ ){
    ...
    $.fn.factoryBootstrap313_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap313_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-313 .factory-gradient").factoryBootstrap313_gradientControl();
    });
