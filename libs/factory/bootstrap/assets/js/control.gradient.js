( function( $ ){
    ...
    $.fn.factoryBootstrap309_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap309_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-309 .factory-gradient").factoryBootstrap309_gradientControl();
    });
