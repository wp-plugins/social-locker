( function( $ ){
    ...
    $.fn.factoryBootstrap312_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap312_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-312 .factory-gradient").factoryBootstrap312_gradientControl();
    });
