( function( $ ){
    ...
    $.fn.factoryBootstrap323_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap323_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-323 .factory-gradient").factoryBootstrap323_gradientControl();
    });
