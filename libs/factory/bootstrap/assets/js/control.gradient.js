( function( $ ){
    ...
    $.fn.factoryBootstrap308_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap308_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-308 .factory-gradient").factoryBootstrap308_gradientControl();
    });
