( function( $ ){
    ...
    $.fn.factoryBootstrap322_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap322_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-322 .factory-integer").factoryBootstrap322_integerControl();
    });
