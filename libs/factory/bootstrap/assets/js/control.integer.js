( function( $ ){
    ...
    $.fn.factoryBootstrap324_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap324_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-324 .factory-integer").factoryBootstrap324_integerControl();
    });
