( function( $ ){
    ...
    $.fn.factoryBootstrap320_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap320_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-320 .factory-integer").factoryBootstrap320_integerControl();
    });
