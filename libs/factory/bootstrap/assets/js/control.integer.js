( function( $ ){
    ...
    $.fn.factoryBootstrap313_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap313_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-313 .factory-integer").factoryBootstrap313_integerControl();
    });
