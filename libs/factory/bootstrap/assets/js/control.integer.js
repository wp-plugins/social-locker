( function( $ ){
    ...
    $.fn.factoryBootstrap312_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap312_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-312 .factory-integer").factoryBootstrap312_integerControl();
    });
