...
class Factory310_Plugin {
    ...
    public function __construct( $pluginPath, $data ) {
        ...
        do_action('factory_310_plugin_created', $this);
    }
    ...
    protected function activationHook() {
        ...
        do_action('factory_310_plugin_activation', $this);     
    ...
    public function deactivationHook() {
        ...
        do_action('factory_310_plugin_deactivation', $this);     
