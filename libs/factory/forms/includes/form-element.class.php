 ...
 * @since 1.0.0
 */
abstract class FactoryForms311_FormElement {
     ...
     * 
     * @since 1.0.0
     * @var FactoryForms311_HtmlAttributeBuilder 
     */
    private $htmlBuilder;
    ...
    public function __construct( $options, $form ) {
        ...
        $this->htmlBuilder = new FactoryForms311_HtmlAttributeBuilder();
