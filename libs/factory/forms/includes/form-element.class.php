 ...
 * @since 1.0.0
 */
abstract class FactoryForms320_FormElement {
     ...
     * 
     * @since 1.0.0
     * @var FactoryForms320_HtmlAttributeBuilder 
     */
    private $htmlBuilder;
    ...
    public function __construct( $options, $form ) {
        ...
        $this->htmlBuilder = new FactoryForms320_HtmlAttributeBuilder();
