 ...
 * @since 1.0.0
 */
abstract class FactoryForms300_FormElement {
     ...
     * 
     * @since 1.0.0
     * @var FactoryForms300_HtmlAttributeBuilder 
     */
    private $htmlBuilder;
    ...
    public function __construct( $options, $form ) {
        ...
        $this->htmlBuilder = new FactoryForms300_HtmlAttributeBuilder();
