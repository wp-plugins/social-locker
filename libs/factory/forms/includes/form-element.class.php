 ...
 * @since 1.0.0
 */
abstract class FactoryForms322_FormElement {
     ...
     * 
     * @since 1.0.0
     * @var FactoryForms322_HtmlAttributeBuilder 
     */
    private $htmlBuilder;
     ...
     * @param FactoryForms322_Form $form A parent form.
     */
    public function __construct( $options, $form ) {
        ...
        $this->htmlBuilder = new FactoryForms322_HtmlAttributeBuilder();
