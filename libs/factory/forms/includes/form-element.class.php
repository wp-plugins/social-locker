 ...
 * @since 1.0.0
 */
abstract class FactoryForms323_FormElement {
     ...
     * 
     * @since 1.0.0
     * @var FactoryForms323_HtmlAttributeBuilder 
     */
    private $htmlBuilder;
    ...
    public function __construct( $options, $form ) {
        ...
        $this->htmlBuilder = new FactoryForms323_HtmlAttributeBuilder();
