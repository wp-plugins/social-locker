 ...
 */
abstract class FactoryForms320_FormLayout extends FactoryForms320_Holder {
    ...
    public function __construct($options, $form) {
        ...
        $this->addCssClass('factory-forms-320-' . $this->type);  
        $this->addCssClass('factory-forms-320-' . $this->name);
    }
