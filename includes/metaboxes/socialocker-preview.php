...
class SociallockerPreviewMetaBox extends FactoryPR108Metabox
{
    ...
    public function render()
    {
        ...
        <div id="lock-preview-wrap" 
             ...
             data-url="<?php echo $this->plugin->pluginUrl ?>/admin/preview.php">
            <iframe 
                allowtransparency="1" 
                frameborder="0" 
                hspace="0" 
...
$socialLocker->registerMetabox('SociallockerPreviewMetaBox');