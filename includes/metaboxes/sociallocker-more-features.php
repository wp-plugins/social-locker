...
class SociallockerMoreFeatures extends FactoryFR108Metabox
{
    ...
    ?>
        ...
        <?php if ( !get_option('fy_trial_activated_' . $this->plugin->pluginName, false) ) { ?>
            <div class="sl-footer">
                ...
                <a href="<?php onepress_fr108_link_license_manager($this->plugin->pluginName, 'activateTrial') ?>" class="btn btn-danger btn-large">
        ...
        <?php } else { ?>
            <div class="sl-footer">
                ...
                <a href="<?php onepress_fr108_link_license_manager($this->plugin->pluginName, 'activateTrial') ?>" class="sl-buy">or <strong>try</strong> the trial version</a>
            </div>
        <?php } ?>
